...
/// <summary>
/// Mother Grizzly only searches when destroyed by battle; <see cref="Patches.DuelMonsterPetDeathPatch"/> marks the card before it hits the Graveyard.
/// </summary>
public static class YgoMotherGrizzlyBattleDeathGate
{
