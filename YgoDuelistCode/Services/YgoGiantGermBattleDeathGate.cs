...
/// <summary>
/// <see cref="Cards.Monster.Todo.Effect.Giant_Germ"/>: battle-death Blight + deck SS only when destroyed by battle;
/// <see cref="Patches.DuelMonsterPetDeathPatch"/> marks the card before it hits the Graveyard.
/// </summary>
public static class YgoGiantGermBattleDeathGate
{
