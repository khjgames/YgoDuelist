...
/// <summary>
/// <see cref="Cards.Monster.Todo.Effect.Lord_Poison"/>: optional Plant SS from GY only when destroyed by battle;
/// <see cref="Patches.DuelMonsterPetDeathPatch"/> marks the card before it hits the Graveyard.
/// </summary>
public static class YgoLordPoisonBattleDeathGate
{
