...
/// </summary>
public sealed class Rolled_1 : MonsterCommandCard
{
    public Rolled_1()
    {
    }

    public Rolled_1(NormalMonsterCard source)
    ...
    public override string PortraitPath => "YgoDuelist/images/card_frames/Rolled_1.png";
}
