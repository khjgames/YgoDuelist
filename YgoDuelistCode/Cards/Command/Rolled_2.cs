...
/// </summary>
public sealed class Rolled_2 : MonsterCommandCard
{
    public Rolled_2()
    {
    }

    public Rolled_2(NormalMonsterCard source)
    ...
    public override string PortraitPath => "YgoDuelist/images/card_frames/Rolled_2.png";
}
