...
/// </summary>
public sealed class Rolled_5 : MonsterCommandCard
{
    public Rolled_5()
    {
    }

    public Rolled_5(NormalMonsterCard source)
    ...
    public override string PortraitPath => "YgoDuelist/images/card_frames/Rolled_5.png";
}
