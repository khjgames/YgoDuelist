...
/// </summary>
public sealed class Rolled_3 : MonsterCommandCard
{
    public Rolled_3()
    {
    }

    public Rolled_3(NormalMonsterCard source)
    ...
    public override string PortraitPath => "YgoDuelist/images/card_frames/Rolled_3.png";
}
