...
/// </summary>
public sealed class Rolled_4 : MonsterCommandCard
{
    public Rolled_4()
    {
    }

    public Rolled_4(NormalMonsterCard source)
    ...
    public override string PortraitPath => "YgoDuelist/images/card_frames/Rolled_4.png";
}
