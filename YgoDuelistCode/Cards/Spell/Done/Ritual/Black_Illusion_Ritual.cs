...
public sealed class Black_Illusion_Ritual : RitualSpellCard
{
    public Black_Illusion_Ritual()
        : base(
            cost: 1,
            rarity: CardRarity.Common,
            target: TargetType.Self,
            spellRace: DuelMonsterRace.SpellRitual,
            ritualTargetMonsterType: typeof(Relinquished),
            levelRequirement: 1,
            materialLevelCompare: RitualMaterialLevelCompare.AtLeast,
            exactMaterialCardCount: 1)
    {
    }
