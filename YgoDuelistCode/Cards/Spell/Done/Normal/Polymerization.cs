...
public sealed class Polymerization : FusionSpellCard
{
    ...
    public override YgoCardPackTags PackTags => YgoCardPackTags.MultiplayerSafe | YgoCardPackTags.Starter | YgoCardPackTags.Fusion | YgoCardPackTags.Spell;
    ...
    /// </summary>
    public override float PackWeightMultiplier => 1.85f;
    ...
    /// </summary>
    public override float DuplicateFatigue => 0.85f;
