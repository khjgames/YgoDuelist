...
public sealed class Salamandra : BaseEquipSpellCard
{
    public Salamandra()
    ...
    //    YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Fire | YgoCardPackTags.Burn | YgoCardPackTags.Dragon;
