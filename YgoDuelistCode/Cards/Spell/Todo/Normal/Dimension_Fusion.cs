...
/// <summary>
/// Not a Fusion Summon spell: mass Special Summon from banished. Named for historical TCG wording only.
/// </summary>
public sealed class Dimension_Fusion : BaseSpellCard
{
    public Dimension_Fusion()
