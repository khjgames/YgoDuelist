...
/// </summary>
public sealed class Barrel_Dragon : EffectMonsterCard, IMonsterActivatedEffect
{
    private const string CoinSalt = "BARREL_DRAGON-COIN";

    public Barrel_Dragon()
        : base(
            cost: 1,
    ...
    public string ActivatedEffectDescriptionLocKey => "YGODUELIST-BARREL_DRAGON.activated_effect.description";
    ...
    public async Task OnActivatedEffect(PlayerChoiceContext choiceContext, CardPlay cardPlay, NormalMonsterCard source)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ulong mix = YgoDeterministicRng.MixDuelMonsterAttack(player.Creature, pet, cardPlay) ^ (ulong)(i + 1);
