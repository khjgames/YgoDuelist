...
public sealed class King_Dragun : FusionMonsterCard
{
    ...
    public King_Dragun()
        : base(
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Lord_of_D),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Divine_Dragon_Ragnarok))
    {
    }
    ...
    /// </summary>
    public override float PackWeightMultiplier => 1.15f * 0.7f;
