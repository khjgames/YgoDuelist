...
public sealed class Crimson_Sunbird : FusionMonsterCard
{
    public override bool BulkBundled => true;

    public Crimson_Sunbird()
        : base(
            cost: 1,
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Faith_Bird),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Skull_Red_Bird))
    {
    }
