...
public sealed class Thousand_Dragon : FusionMonsterCard
{
    public override bool BulkBundled => true;

    public Thousand_Dragon()
        : base(
            cost: 1,
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Time_Wizard),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Baby_Dragon))
    {
    }
