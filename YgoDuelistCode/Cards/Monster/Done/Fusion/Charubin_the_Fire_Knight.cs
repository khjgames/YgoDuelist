...
public sealed class Charubin_the_Fire_Knight : FusionMonsterCard
{
    ...
    public Charubin_the_Fire_Knight()
        : base(
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Monster_Egg),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Hinotama_Soul))
    {
    }
