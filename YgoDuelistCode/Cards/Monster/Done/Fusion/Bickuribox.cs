...
public sealed class Bickuribox : FusionMonsterCard
{
    ...
    public Bickuribox()
        : base(
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Crass_Clown),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Dream_Clown))
    {
    }
