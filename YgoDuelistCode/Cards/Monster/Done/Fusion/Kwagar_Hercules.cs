...
public sealed class Kwagar_Hercules : FusionMonsterCard
{
    public override bool BulkBundled => true;

    public Kwagar_Hercules()
        : base(
            cost: 1,
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Kuwagata),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Hercules_Beetle))
    {
    }
