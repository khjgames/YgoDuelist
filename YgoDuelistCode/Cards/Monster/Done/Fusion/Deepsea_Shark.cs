...
public sealed class Deepsea_Shark : FusionMonsterCard
{
    ...
    public Deepsea_Shark()
        : base(
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Bottom_Dweller),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Tongyo))
    {
    }
