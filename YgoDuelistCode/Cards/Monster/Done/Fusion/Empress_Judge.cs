...
public sealed class Empress_Judge : FusionMonsterCard
{
    public override bool BulkBundled => true;

    public Empress_Judge()
        : base(
            cost: 1,
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Queen_s_Double),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Hibikime))
    {
    }
