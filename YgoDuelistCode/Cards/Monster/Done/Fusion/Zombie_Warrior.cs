...
public sealed class Zombie_Warrior : FusionMonsterCard
{
    ...
    public Zombie_Warrior()
        : base(
            ...
            {
                typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Skull_Servant),
                typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Battle_Warrior)
            }
            )
    {
    }
