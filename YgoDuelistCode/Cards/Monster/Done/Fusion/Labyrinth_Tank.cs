...
public sealed class Labyrinth_Tank : FusionMonsterCard
{
    public override bool BulkBundled => true;

    public Labyrinth_Tank()
        : base(
            cost: 1,
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Giga_Tech_Wolf),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Effect.Cannon_Soldier))
    {
    }
