...
public sealed class Pragtical : FusionMonsterCard
{
    ...
    public Pragtical()
        : base(
            ...
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Trakodon),
            typeof(global::YgoDuelist.YgoDuelistCode.Cards.Monster.Done.Normal.Flame_Viper))
    {
    }
