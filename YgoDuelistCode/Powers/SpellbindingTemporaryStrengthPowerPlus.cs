...
public sealed class SpellbindingTemporaryStrengthPowerPlus : TemporaryStrengthPower, ICustomModel
{
    ...
    public override LocString Title => new("powers", "YGODUELIST-SPELLBINDING_TEMPORARY_STRENGTH_POWER_PLUS.title");

    public override LocString Description => new("powers", "YGODUELIST-SPELLBINDING_TEMPORARY_STRENGTH_POWER_PLUS.description");
