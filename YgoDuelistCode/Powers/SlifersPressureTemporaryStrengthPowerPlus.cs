...
public sealed class SlifersPressureTemporaryStrengthPowerPlus : TemporaryStrengthPower, ICustomPower
{
    ...
    private const int DefaultBlightAmount = 13;
    ...
    protected override string SmartDescriptionLocKey => "YGODUELIST-SLIFERS_PRESSURE_POWER_PLUS.smartDescription";
