...
/// <summary>
/// Intercepts Neow's first <see cref="AncientEventModel.SetInitialEventState"/> for YgoDuelist: starter grid (18 random Starter-tagged cards, pick 10–18) then Neow blessing UI.
/// </summary>
