...
DATA = [
    ...
    ("Spell/Todo/Normal/Upstart_Goblin.cs", "Upstart_Goblin",
     "YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Draw | YgoCardPackTags.Burn", None,
    ...
    ("Trap/Todo/Normal/Enchanted_Javelin.cs", "Enchanted_Javelin",
     "YgoCardPackTags.Starter | YgoCardPackTags.Trap | YgoCardPackTags.Heal", None,
    ...
    ("Spell/Todo/Normal/Spellbook_Organization.cs", "Spellbook_Organization",
     "YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Draw", "Uncommon",
     "    }\n\n    protected override async Task OnSpellPlay"),
    ("Spell/Todo/Equip/Cestus_of_Dagla.cs", "Cestus_of_Dagla",
     "YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Heal", "Uncommon",
     "    }\n\n    public override bool CanEquipTo"),
    ...
    ("Spell/Pot_Of_Greed.cs", "Pot_Of_Greed",
     "YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Draw", "Rare",
     "    }\n\n    protected override async Task OnSpellPlay"),
    ...
    ("Spell/Foolish_Burial.cs", "Foolish_Burial",
     "YgoCardPackTags.Starter | YgoCardPackTags.Spell | YgoCardPackTags.Draw", None,
     "    }\n\n    protected override void OnUpgrade"),
]
